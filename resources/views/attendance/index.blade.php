        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        @if($s->photo)
                        <span style="display:inline-flex;width:36px;height:36px;border-radius:50%;overflow:hidden;background:var(--gray-200);align-items:center;justify-content:center;font-weight:600;">
